  ...
  const events = [
    {
      ...
      image: "/placeholder.svg?height=600&width=1200&query=female flamenco dancer in red dress on stage with spotlight",
      price: 45,
      performers: [
        {
          name: "Carmen Romero",
          ...
          image: "/placeholder.svg?height=300&width=300&query=female flamenco dancer portrait",
        },
        {
          name: "Miguel Fernández",
          role: "Guitarist",
          bio: "A virtuoso guitarist who has performed worldwide and recorded with some of the greatest flamenco artists.",
          image: "/placeholder.svg?height=300&width=300&query=male flamenco guitarist portrait",
        },
        {
          name: "Rafael Cortés",
          role: "Singer",
          bio: "Rafael's deep, soulful voice carries the centuries-old tradition of flamenco singing with authentic passion.",
          image: "/placeholder.svg?height=300&width=300&query=male flamenco singer portrait",
        },
      ],
    },
    {
      ...
      performers: [
        {
          ...
          image: "/placeholder.svg?height=300&width=300&query=young female flamenco dancer portrait",
        },
        {
          name: "Antonio Reyes",
          role: "Percussionist",
          bio: "Antonio's rhythmic precision on the cajón adds depth and texture to our flamenco performances.",
          image: "/placeholder.svg?height=300&width=300&query=male flamenco percussionist portrait",
        },
        {
          name: "Isabel Flores",
          ...
          image: "/placeholder.svg?height=300&width=300&query=mature female flamenco dancer portrait",
        },
      ],
    },
  ]
          ...
          <div className="grid gap-8 md:grid-cols-3 mt-8">
              ...
              <div>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {event.performers.map((performer) => (
                    <div key={performer.name} className="flex flex-col items-center text-center">
                      ...
                      <p className="text-sm bg-flamenco hover:bg-flamenco-hover mb-2">{performer.role}</p>
                      <p className="text-sm text-muted-foreground">{performer.bio}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div>
              <div className="rounded-lg border bg-card p-6 shadow-sm sticky top-24">
                ...
                <BookingForm eventId={event.id} eventTitle={event.title} price={event.price} />
              </div>
            </div>
          </div>
        </div>
